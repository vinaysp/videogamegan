...
from GAN_Nets_Mario import get_disc_normal, get_gen_normal
...
def sample_from_dataset(batch_size, image_shape, data_dir='marioimages_data', data = 'marioimages_data/*.png'):
    ...
    for index,img_filename in enumerate(sample_imgs_paths):
        ...
        sample[index,...] = image.T[2,1,0]
        #np.rot90(image.T[2,1,0])
    return sample
...
#image_shape = (96,96,3)
image_shape = (3232,208,3)
data_dir =  "marioimages_data/*.png"
